    ...
    get() {
        ...
        while (this.newItemsExist(markings)) {
            ...
            while (this.newItemsExist(possibleTransitions)) {
                ...
                let nextMarking = this.getNextMarking(markings.length, possibleTransitions[transitionIndex].transition.id, markings[markingIndex]);
                if (!this.nextMarkingIsNew(nextMarking, markings)) {
                    nextMarking.label = "old";
                    nextMarking.name = this.getNameForExistingMarking(nextMarking, markings);
                } else {
